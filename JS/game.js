...
function movement()
{
	...
	encounter_bush(); //check to see if hero has found a blackberry bush obstacle
	encounter_rock(); //check to see if hero has found a rock obstacle
	encounter_tree(); //check to see if hero has found a tree obstacle
}
